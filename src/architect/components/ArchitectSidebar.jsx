...
import { LayoutDashboard, FolderKanban, ClipboardList, Users, ChevronLeft, ChevronRight } from "lucide-react";

const navItems = [
  { title: "Dashboard", url: "/architect", icon: LayoutDashboard },
  { title: "Projects", url: "/architect/projects", icon: FolderKanban },
  { title: "Tasks", url: "/architect/tasks", icon: ClipboardList },
  { title: "Clients", url: "/architect/clients", icon: Users },
];
